...
$mail->Username = 'b08901088@ntu.edu.tw'; // SMTP username
$mail->Password = 'XXXXXXXX'; // 信箱密碼(自己測試就好，記得上傳時要把密碼刪掉)
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587; // TCP port to connect to

$mail->setFrom('b08901088@ntu.edu.tw', '二手書網站'); //寄件的Gmail
$mail->addAddress('webber75795@gmail.com', '張裴勻'); // 收件的信箱
